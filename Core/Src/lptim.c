...
void MX_LPTIM1_Init(void)
{
  ...
  sConfig.ICInputSource = LPTIM_IC2SOURCE_LSI;
  if (HAL_LPTIM_IC_ConfigChannel(&hlptim1, &sConfig, LPTIM_CHANNEL_2) != HAL_OK)
  {
    Error_Handler();
  }
...
void MX_LPTIM2_Init(void)
{
  ...
  sConfig.ICInputSource = LPTIM_IC2SOURCE_HSI_1024;
